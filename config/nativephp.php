...
return [
     ...
     * For example: com.codewithdennis.pairframe
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.codewithdennis.pairframe'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'NativePHP desktop app to compose light and dark screenshots into split, fade, and patterned thumbnails.'),
